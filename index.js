...
const BIGQUERY_CLIENT = new BIGQUERY({projectId: "principal-yen-302809"}); 
...
exports.dialogflowFirebaseFulfillment = functions.https.onRequest((request, response) => { 
  ...
  const SQLQUERY = `WITH eval_table AS ( SELECT  5 as seniority,'3-Advanced'as experience,  

    @category as category, 'Request' as type) 

  SELECT cast(predicted_label as INT64) as predicted_label 

  FROM ML.PREDICT(MODEL helpdesk.predccion, TABLE eval_table)`;  
